...
public class GUI {
	...
	public void addComponentsToPane(Container pane) 
	{
        ...
        resultLabel = new JLabel("Скорость после столкновения: 0");
        ...
        calculateButton.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent e)
			{
				try
				{
					...
					resultLabel.setText("Скорость после столкновения: " + result);
				}
				catch(NumberFormatException exp)
				{
					resultLabel.setText("Пожалуйста, введите целое число");
				}
			}
		});
	}
